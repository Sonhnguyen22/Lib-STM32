...
//
/**
  * @brief  Ki?m tra tr?ng th�i I2C
  * @param  I2Cx: Port I2C (I2C1, I2C2,...)
  * @param  devAddr: �?a ch? thi?t b? (7-bit)
  * @retval I2C_Status: Tr?ng th�i bus I2C
  */
uint8_t I2C_Check_Error(I2C_TypeDef *I2Cx, uint8_t devAddr){
//{
//    
//    
//    /* 1. Ki?m tra tr?ng th�i BUSY */
//   
//    while((I2Cx->SR2 & I2C_FLAG_BUSY) && ((DWT->CYCCNT - startTime) < timeout)) {
//        // Ch? cho d?n khi bus kh�ng b?n ho?c timeout
//    }
//    if(I2Cx->SR2 & I2C_FLAG_BUSY) return I2C_BUSY;
//    
//    /* 2. K�ch ho?t I2C n?u chua b?t */
...
//        // Thi?t b? ph?n h?i
//        (void)I2Cx->SR1; // �?c SR1 d? x�a ADDR flag
//        (void)I2Cx->SR2; // �?c SR2 (b?t bu?c)
//        I2Cx->CR1 |= I2C_CR1_STOP; // T?o Stop condition
//        return I2C_OK;
//    }
//    else if(I2Cx->SR1 & I2C_FLAG_AF) {
//        // Thi?t b? kh�ng ph?n h?i (NACK)
//        I2Cx->SR1 &= ~I2C_FLAG_AF; // X�a AF flag
//        I2Cx->CR1 |= I2C_CR1_STOP; // T?o Stop condition
...
void I2C_UnlockBus(I2C_HandleTypeDef* hi2c, I2C_TypeDef* I2Cx, uint32_t Baudrate) {
  ...
  // 1. C?u h�nh SCL & SDA th�nh Output Mode
  __HAL_RCC_GPIOB_CLK_ENABLE(); 
